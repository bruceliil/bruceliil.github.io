...
GeometryHelper.prototype = {
    ...
    computeVertexNormals: function (bufferGeometry) {
      if (bufferGeometry.drawMode === THREE.TrianglesDrawMode) {
        ...
        var outNormals = bufferGeometry.attributes.normal.array;

        var pos0 = new THREE.Vector3();
        var pos1 = new THREE.Vector3();
        var pos2 = new THREE.Vector3();
        var posDif0 = new THREE.Vector3(), posDif1 = new THREE.Vector3();
        var localNormal = new THREE.Vector3();

        const stripIndices = bufferGeometry.index.array;
        for (var i = 2; i < stripIndices.length; ++i) {
          var index0 = stripIndices[i - 2] * 3;
          var index1 = stripIndices[i - 1] * 3;
          var index2 = stripIndices[i] * 3;
