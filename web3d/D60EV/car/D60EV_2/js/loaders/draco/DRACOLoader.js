...
THREE.DRACOLoader.prototype = {
    ...
    load: function(url, onLoad, onProgress, onError,nameID) {
	
	    //console.log("xxxxxxxx000:",nameID);
        var scope = this;
        ...
        loader.load(url, function(blob) {
            scope.decodeDracoFile(blob, onLoad, undefined ,nameID);
			//console.log("xxxxxxxx111:",nameID);
        }, onProgress, onError);
    },
     ...
     */
    decodeDracoFile: function(rawBuffer, callback, attributeUniqueIdMap,nameID) {
      var scope = this;
	  
	  //console.log("xxxxxxxx222-:",nameID)
      this.attributeUniqueIdMap = (attributeUniqueIdMap !== undefined) ?
          attributeUniqueIdMap : {};
      THREE.DRACOLoader.getDecoderModule(
          function(dracoDecoder) {
		  
            scope.decodeDracoFileInternal(rawBuffer, dracoDecoder, callback,nameID);
      });
    },

    decodeDracoFileInternal: function(rawBuffer, dracoDecoder, callback,nameID) {
      /*
